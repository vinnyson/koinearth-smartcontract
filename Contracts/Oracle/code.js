                  ...
                  "args": [
                    { "prim": "map", "args": [ { "prim": "address" }, { "prim": "string" } ], "annots": [ "%signerAddressAlias" ] },
                    {
                      ...
                      "args": [
                        {
                          "prim": "map",
                          "args": [ { "prim": "nat" }, { "prim": "map", "args": [ { "prim": "bytes" }, { "prim": "map", "args": [ { "prim": "address" }, { "prim": "bool" } ] } ] } ],
          ...
          "args": [
            {
              ...
              "args": [
                { "prim": "pair", "args": [ { "prim": "address", "annots": [ "%address" ] }, { "prim": "string", "annots": [ "%alias" ] } ] },
                {
                  "prim": "pair",
                  "args": [
                    { "prim": "key", "annots": [ "%publicSignerHash" ] },
              ...
              [
                ...
                { "prim": "MEM" },
                {
                  ...
                  "args": [
                    [],
                    [
                      { "prim": "PUSH", "args": [ { "prim": "string" }, { "string": "WrongCondition: self.data.whiteListedAddresses.contains(params.signerPublicKey)" } ] },
                      { "prim": "FAILWITH" }
                    ]
                  ]
                },
                { "prim": "PUSH", "args": [ { "prim": "string" }, { "string": "I am the signer" } ] },
                { "prim": "PACK" },
                { "prim": "SWAP" },
                { "prim": "DUP" },
                { "prim": "CDR" },
                    ...
                    [
                      ...
                      { "prim": "MEM" },
                      {
                        ...
                        "args": [
                          [],
                          [
                            { "prim": "PUSH", "args": [ { "prim": "string" }, { "string": "WrongCondition: self.data.whiteListedAddresses.contains(params._signerPublicKey)" } ] },
                            { "prim": "FAILWITH" }
                          ]
                        ]
                      },
                      ...
                      { "prim": "EQ" },
                      {
                        ...
                        "args": [
                          [
                            ...
                            { "prim": "CDR" },
                            { "prim": "GET" },
                            { "prim": "IF_NONE", "args": [ [ { "prim": "PUSH", "args": [ { "prim": "int" }, { "int": "113" } ] }, { "prim": "FAILWITH" } ], [] ] },
                            { "prim": "DIG", "args": [ { "int": "2" } ] },
                            { "prim": "DUP" },
                            { "prim": "DUG", "args": [ { "int": "3" } ] },
                            { "prim": "CAR" },
                            ...
                            { "prim": "EQ" },
                            {
                              ...
                              "args": [
                                [
                                            ...
                                            "args": [
                                              {
                                                ...
                                                "args": [
                                                  ...
                                                  {
                                                    "prim": "pair",
                                                    "args": [ { "prim": "address", "annots": [ "%oracleContract" ] }, { "prim": "string", "annots": [ "%state" ] } ]
                                                  }
                                                ]
                                              },
                                              {
                                  ...
                                  { "prim": "DUG", "args": [ { "int": "2" } ] },
                                  { "prim": "GET" },
                                  { "prim": "IF_NONE", "args": [ [ { "prim": "PUSH", "args": [ { "prim": "int" }, { "int": "132" } ] }, { "prim": "FAILWITH" } ], [] ] },
                                  {
                                    "prim": "NONE",
                                    "args": [
                                      {
