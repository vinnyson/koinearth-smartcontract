            ...
            "args": [
              {
                "prim": "pair",
                "args": [
                  { "prim": "map", "args": [ { "prim": "key" }, { "prim": "string" } ], "annots": [ "%signerAddressAlias" ] },
                  {
                    "prim": "pair",
                    "args": [
                      {
                        "prim": "map",
                        "args": [ { "prim": "nat" }, { "prim": "map", "args": [ { "prim": "bytes" }, { "prim": "map", "args": [ { "prim": "key" }, { "prim": "bool" } ] } ] } ],
                                        ...
                                        "args": [
                                          { "prim": "bytes", "annots": [ "%_hash" ] },
                                          {
                                            ...
                                            "args": [
                                              ...
                                              { "prim": "set", "args": [ { "prim": "key" } ], "annots": [ "%authorities" ] }
                                            ]
                                          }
                                        ]
                                      },
                ...
                "args": [
                  {
                    ...
                    "args": [
                      ...
                      { "prim": "map", "args": [ { "prim": "nat" }, { "prim": "map", "args": [ { "prim": "bytes" }, { "prim": "address" } ] } ], "annots": [ "%tokerOwner" ] }
                    ]
                  },
                  {
                    "prim": "pair",
                    "args": [
                      { "prim": "set", "args": [ { "prim": "key" } ], "annots": [ "%whiteListedAddresses" ] },
        ...
        { "prim": "CAR" },
        {
          ...
          "args": [
            [
              ...
              { "prim": "CDR" },
              { "prim": "MEM" },
              { "prim": "IF", "args": [ [ { "prim": "PUSH", "args": [ { "prim": "string" }, { "string": "Already whitelisted" } ] }, { "prim": "FAILWITH" } ], [] ] },
              { "prim": "SWAP" },
              { "prim": "DUP" },
              { "prim": "DUG", "args": [ { "int": "2" } ] },
              { "prim": "CDR" },
              ...
              { "prim": "BLAKE2B" },
              { "prim": "MEM" },
              { "prim": "IF", "args": [ [ { "prim": "PUSH", "args": [ { "prim": "string" }, { "string": "signature already exist" } ] }, { "prim": "FAILWITH" } ], [] ] },
              { "prim": "DUP" },
              { "prim": "CAR" },
              { "prim": "CAR" },
              { "prim": "SWAP" },
                ...
                "args": [
                  [
                    ...
                    { "prim": "MEM" },
                    {
                      ...
                      "args": [
                        [],
                        [
                          { "prim": "PUSH", "args": [ { "prim": "string" }, { "string": "WrongCondition: self.data.whiteListedAddresses.contains(params._publicSignerHash)" } ] },
                          { "prim": "FAILWITH" }
                        ]
                      ]
                    },
                    ...
                    { "prim": "CAR" },
                    { "prim": "MEM" },
                    { "prim": "IF", "args": [ [], [ { "prim": "PUSH", "args": [ { "prim": "string" }, { "string": "No to address found" } ] }, { "prim": "FAILWITH" } ] ] },
                    { "prim": "SWAP" },
                    { "prim": "DUP" },
                    { "prim": "DUG", "args": [ { "int": "2" } ] },
                    { "prim": "CDR" },
                    ...
                    },
                    {
                      ...
                      "args": [
                        [
                          ...
                          {
                            "prim": "IF",
                            "args": [ [], [ { "prim": "PUSH", "args": [ { "prim": "string" }, { "string": "Ambiguity in to address" } ] }, { "prim": "FAILWITH" } ] ]
                          }
                        ],
                        [
                          { "prim": "SWAP" },
                    ...
                    { "prim": "MEM" },
                    {
                      ...
                      "args": [
                        [
                          ...
                          { "prim": "CDR" },
                          { "prim": "GET" },
                          { "prim": "IF_NONE", "args": [ [ { "prim": "PUSH", "args": [ { "prim": "int" }, { "int": "109" } ] }, { "prim": "FAILWITH" } ], [] ] },
                          { "prim": "DIG", "args": [ { "int": "2" } ] },
                          { "prim": "DUP" },
                          { "prim": "DUG", "args": [ { "int": "3" } ] },
                          { "prim": "CAR" },
                    ...
                    { "prim": "COMPARE" },
                    { "prim": "EQ" },
                    { "prim": "IF", "args": [ [ { "prim": "PUSH", "args": [ { "prim": "string" }, { "string": "Already minted" } ] }, { "prim": "FAILWITH" } ], [] ] },
                    ...
                    { "prim": "EQ" },
                    {
                      ...
                      "args": [
                          ...
                          { "prim": "MEM" },
                          {
                            ...
                            "args": [
                              [
                                ...
                                { "prim": "CDR" },
                                { "prim": "GET" },
                                { "prim": "IF_NONE", "args": [ [ { "prim": "PUSH", "args": [ { "prim": "int" }, { "int": "115" } ] }, { "prim": "FAILWITH" } ], [] ] },
                                { "prim": "SWAP" },
                                { "prim": "DUP" },
                                { "prim": "DUG", "args": [ { "int": "2" } ] },
                                { "prim": "CAR" },
                                    ...
                                    [
                                      {
                                        ...
                                        "args": [
                                          { "prim": "string" },
                                          { "string": "WrongCondition: self.data.tokenAuthSings[params.tokenId][params._hash][params._publicSignerHash] == False" }
                                        ]
                                      },
                                      { "prim": "FAILWITH" }
                                    ]
                          ...
                          { "prim": "EQ" },
                          {
                            ...
                            "args": [
                              ...
                              [
                                {
                                  "prim": "PUSH",
                                  "args": [ { "prim": "string" }, { "string": "WrongCondition: self.data.tokenData[params.tokenId][params._hash].state == params._state" } ]
                                },
                                { "prim": "FAILWITH" }
                              ]
                            ]
                        ...
                        [
                          ...
                          },
                          {
                            ...
                            "args": [
                              [
                                ...
                                { "prim": "CDR" },
                                { "prim": "GET" },
                                { "prim": "IF_NONE", "args": [ [ { "prim": "PUSH", "args": [ { "prim": "int" }, { "int": "127" } ] }, { "prim": "FAILWITH" } ], [] ] },
                                { "prim": "DIG", "args": [ { "int": "2" } ] },
                                { "prim": "DUP" },
                                { "prim": "DUG", "args": [ { "int": "3" } ] },
                                { "prim": "CAR" },
                          ...
                          { "prim": "CDR" },
                          { "prim": "CDR" },
                          { "prim": "EMPTY_MAP", "args": [ { "prim": "bytes" }, { "prim": "map", "args": [ { "prim": "key" }, { "prim": "bool" } ] } ] },
                          { "prim": "EMPTY_MAP", "args": [ { "prim": "key" }, { "prim": "bool" } ] },
                          { "prim": "PUSH", "args": [ { "prim": "option", "args": [ { "prim": "bool" } ] }, { "prim": "Some", "args": [ { "prim": "True" } ] } ] },
                          { "prim": "DIG", "args": [ { "int": "9" } ] },
                          { "prim": "DUP" },
                          { "prim": "DUG", "args": [ { "int": "10" } ] },
                    ...
                    },
                    {
                      ...
                      "args": [
                        [
                          ...
                          { "prim": "CDR" },
                          { "prim": "GET" },
                          { "prim": "IF_NONE", "args": [ [ { "prim": "PUSH", "args": [ { "prim": "int" }, { "int": "148" } ] }, { "prim": "FAILWITH" } ], [] ] },
                          { "prim": "DIG", "args": [ { "int": "2" } ] },
                          { "prim": "DUP" },
                          { "prim": "DUG", "args": [ { "int": "3" } ] },
                          { "prim": "CAR" },
                          ...
                          { "prim": "EQ" },
                          {
                            ...
                            "args": [
                              [
                                          ...
                                          "args": [
                                            {
                                              ...
                                              "args": [
                                                { "prim": "bytes", "annots": [ "%_hash" ] },
                                                { "prim": "pair", "args": [ { "prim": "address", "annots": [ "%address" ] }, { "prim": "string", "annots": [ "%assetType" ] } ] }
                                              ]
                                            },
                                            {
                                              "prim": "pair",
                                ...
                                { "prim": "DUG", "args": [ { "int": "2" } ] },
                                { "prim": "GET" },
                                { "prim": "IF_NONE", "args": [ [ { "prim": "PUSH", "args": [ { "prim": "int" }, { "int": "182" } ] }, { "prim": "FAILWITH" } ], [] ] },
                                { "prim": "DIG", "args": [ { "int": "8" } ] },
                                { "prim": "DUP" },
                                { "prim": "DUG", "args": [ { "int": "9" } ] },
                                { "prim": "CAR" },
                                { "prim": "CAR" },
                                { "prim": "CDR" },
                                { "prim": "PUSH", "args": [ { "prim": "option", "args": [ { "prim": "nat" } ] }, { "prim": "Some", "args": [ { "int": "2" } ] } ] },
                                { "prim": "SWAP" },
                                { "prim": "UPDATE" },
                                { "prim": "SOME" },
                                { "prim": "SWAP" },
                  ...
                  [
                    ...
                    { "prim": "EQ" },
                    {
                      ...
                      "args": [
                        [],
                        [ { "prim": "PUSH", "args": [ { "prim": "string" }, { "string": "WrongCondition: sp.sender == self.data.adminAddress" } ] }, { "prim": "FAILWITH" } ]
                      ]
                    },
                    { "prim": "SWAP" },
                    { "prim": "DUP" },
